...
export function EmptyState({
  ...
  return (
    <section className={cn('rounded-[2rem] border border-[#dce3d7] bg-white p-8 text-center shadow-[0_16px_35px_rgba(12,39,77,0.05)]', className)}>
      <div className="mx-auto flex h-14 w-14 items-center justify-center rounded-full bg-[var(--slot4-highlight)] text-[var(--slot4-accent)]">
      ...
      <Link href={actionHref} className="mt-6 inline-flex items-center gap-2 rounded-full bg-[linear-gradient(135deg,var(--slot4-accent-fill),#3c68ff)] px-5 py-3 text-sm font-semibold text-white transition hover:-translate-y-0.5">
        {actionLabel}
